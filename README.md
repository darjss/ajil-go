...
**Ajil-Go** нь TaskRabbit-тэй адил төстэй, хэрэглэгчид жижиг ажил даалгавар үүсгэж, бусад хэрэглэгчид тэдгээр дээр тендер өгөх боломжтой микро ажлын зах зээлийн платформ юм.

## 📋 Төслийн тухай

Энэхүү платформ нь:
- 👥 Ажил олгогчид (Task Posters) өөрсдийн хийлгэхийг хүсч буй ажлуудыг нийтэлдэг
- 💼 Ажил хийгчид (Workers) ажил дээр тендер өгч, ажил хүлээн авдаг
...
- ✅ Google-ээр нэвтрэх (Social Login)
